// components/guild/LinkDAOModal.js
// Modal for the guild owner to browse and link a DAO to their guild.
    ...
    >
      <View style={[s.container, { backgroundColor: COLORS.background }]}>
        ...
        <Text style={[s.subtitle, { color: COLORS.textSecondary }]}>
          Linking a DAO adds a Governance tab to your guild — members can view proposals
          and vote without leaving the guild.
        </Text>
