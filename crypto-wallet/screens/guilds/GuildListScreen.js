...
// ── Guild row ─────────────────────────────────────────────────────────────────
const GuildRow = React.memo(({ item, COLORS, onPress, onTogglePin }) => {
...
// ── Screen ────────────────────────────────────────────────────────────────────
const GuildListScreen = ({ navigation }) => {
  const { COLORS, SPACING } = useTheme();
  const { guilds, loading, syncing, refresh, togglePin } = useGuilds();

  const handleTogglePin = useCallback(async (guildId) => {
    try { await togglePin(guildId); }
        ...
        <FlatList
          ...
          ListEmptyComponent={
            <View style={empty.wrap}>
              ...
              <Text style={[empty.title, { color: COLORS.text }]}>No Guilds Yet</Text>
              ...
              <View style={empty.actions}>
                ...
                >
                  ...
                  <Text style={empty.btnText}>Browse Guilds</Text>
                </TouchableOpacity>
                <TouchableOpacity
                ...
                >
                  ...
                  <Text style={[empty.btnText, { color: COLORS.primary }]}>Create Guild</Text>
                </TouchableOpacity>
              </View>
            </View>
          }
