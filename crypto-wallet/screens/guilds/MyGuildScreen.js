...
const MyGuildScreen = ({ navigation }) => {
  const { user } = useAuth();
  ...
  const fetchMyGuilds = async () => {
    ...
    try {
      ...
      console.error("[MyGuildScreen] fetchMyGuilds failed:", err.message);
  ...
  if (error) {
    return (
      <View style={styles.errorContainer}>
        ...
        <Text style={styles.errorText}>Error loading your guilds</Text>
        <Text style={styles.errorSubtext}>{error}</Text>
        <TouchableOpacity style={styles.retryButton} onPress={fetchMyGuilds}>
      ...
      >
        <View style={styles.header}>
          <View style={styles.headerTop}>
            ...
            <Text style={styles.headerTitle}>My Guilds</Text>
        ...
        <FlatList
          ...
          ListEmptyComponent={
            <View style={styles.emptyContainer}>
              ...
              <Text style={styles.emptyText}>No guilds yet</Text>
...
const styles = StyleSheet.create({
  ...
  guildItem:        { flexDirection: "row", backgroundColor: "#161B22", borderRadius: 16, borderWidth: 1, borderColor: "#30363D", padding: 16, marginBottom: 12, alignItems: "center" },
